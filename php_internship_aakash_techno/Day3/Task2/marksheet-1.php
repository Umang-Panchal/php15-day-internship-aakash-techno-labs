...
echo "
<div class='container'>
    <h2 align='center'>Your Marksheet</h2> <br>
...
<tr align='center'>
        <td colspan='2'>
           <?php
            ...
            elseif ($grade=="B") {
                echo "<p style='color:orange;'>First class with Grade $grade</p>";
            }
            elseif ($grade=="C") {
                echo "<p style='color:blue;'>Second class with Grade $grade</p>";
            }
            elseif ($grade=="D") {
                echo "<p style='color:yellow;'>Third class with Grade $grade</p>";
            }
            elseif ($grade=="FAIL") {
                echo "<p style='color:red;'>You haven't Cleared the exam</p>";
            }
           ?>
        </td>
    </tr>  
